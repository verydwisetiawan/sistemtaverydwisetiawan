    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url('home') ?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">RSUD Arifin</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?= base_url('home') ?>" class="d-block"><?= $this->session->userdata('nama') ?></a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; <?= date('Y') ?> </strong> Tugas Akhir
        </footer>
